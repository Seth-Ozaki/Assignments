...
<div class="container">
	<h1> Edit ${editTeam.teamName}</h1>
	<form:form action="/teams/edit/${editTeam.getId()}" method="put" modelAttribute="editTeam">
		<div class="mb-3">
		...
		<div class="mb-3">
			...
			<a href="/teams/${editTeam.getId()}" class="btn btn-danger">Cancel</a>
		</form:form>
	</div>
</body>
</html>