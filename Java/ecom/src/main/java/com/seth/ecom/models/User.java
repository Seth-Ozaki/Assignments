...
public class User {
    ...
    private List<Item> shoppersItems;
	...
	public List<Item> getShoppersItems() {
		return shoppersItems;
	}

	public void setShoppersItems(List<Item> shoppersItems) {
		this.shoppersItems = shoppersItems;
	}
